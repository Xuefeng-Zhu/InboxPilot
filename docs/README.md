...
- **Corrected** to reflect the current state of the code: 9 InsForge Deno functions, 12 Next.js API routes, 20 application tables, 15 repositories, 20 migration files, 3 channels (SMS, email, webchat), and React Query on the frontend. Last verified: 2026-07-20.
