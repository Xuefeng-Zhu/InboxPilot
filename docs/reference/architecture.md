...
**20 application tables, 22 migration files, 13 application-callable RPCs.** See [`database.md`](database.md) for the full schema, RLS policies, indexes, and ER diagram.
