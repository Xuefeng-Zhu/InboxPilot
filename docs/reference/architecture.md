...
**20 application tables, 21 migration files, 9 application-callable RPCs.** See [`database.md`](database.md) for the full schema, RLS policies, indexes, and ER diagram.
