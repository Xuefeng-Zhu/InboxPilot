...
**20 application tables, 25 migration files, 15 application-callable RPCs.** See [`database.md`](database.md) for the full schema, RLS policies, indexes, and ER diagram.
