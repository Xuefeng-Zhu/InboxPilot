...
| Schema, tables, constraints | `migrations/001_initial_schema.sql` plus later numbered migrations through 023 |
| RLS policies + helpers | `migrations/003_rls_policies.sql`, `005`, `007`, `014`, `015`, `016`, `017`, `018`, `019`, `020`, `021`, `023` |
| RPC functions | `migrations/002`, `004`, `007`, `008`, `012`, `013`, `016`, `018`, `020`, `021`, `022` |
...
- Migration count is **25** (`001` through `023` plus the two timestamped job-trigger migrations).
