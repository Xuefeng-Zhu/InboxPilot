...
| Schema, tables, constraints | `migrations/001_initial_schema.sql` plus later numbered migrations through 022 |
...
- Migration count is **24** (`001` through `022` plus the two timestamped job-trigger migrations).
