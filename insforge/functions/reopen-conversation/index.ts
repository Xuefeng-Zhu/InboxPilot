/**
 * reopen-conversation — Reopens a resolved conversation.
 *
 ...
 * 4. Set conversation status to "open"
...
export default async function (req: Request): Promise<Response> {
  try {
    ...
    // organizationId on success. 'manage_conversations' gates
    // resolve / reopen — granted to owner, admin, AND agent.
